...
namespace TableTop
{
    public class AddedTaskUiItemManager : UiItemManager
    {
        ...
        public static AddedTaskUiItemManager CreateComponent(GameObject where, TaskData taskData, int routeItemNumber)
        {

            where.name = taskData.Name;

            AddedTaskUiItemManager taskUiItemManagerObject = where.AddComponent<AddedTaskUiItemManager>();
