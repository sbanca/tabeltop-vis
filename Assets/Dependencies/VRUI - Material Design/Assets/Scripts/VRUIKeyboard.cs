...
namespace SpaceBear.VRUI
{
    ...
    public class VRUIKeyboard : MonoBehaviour
    {
        ...
        public void OnFocusChange(BaseEventData data) {

          
            Debug.Log("[UI] onSelect event detected: " + data.selectedObject);

            InputField _inputField = data.selectedObject.GetComponent<InputField>();
